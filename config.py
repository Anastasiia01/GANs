...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='mnist', choices=['mnist', 'fashion-mnist', 'cifar'],
    ...
    parser.add_argument('--resume_training', type=str, default='False', help='Whether to resume training or not')
